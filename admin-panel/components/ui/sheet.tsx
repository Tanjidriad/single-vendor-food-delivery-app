  ...
  return (
    <SheetPrimitive.Portal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background fixed z-50 flex flex-col gap-0 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
          side === "right" &&
