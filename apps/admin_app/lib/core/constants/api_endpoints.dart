class ApiEndpoints {
  ...
  static const String ordersOpsQueues = '/orders/ops/queues';
  static String updateOrderStatus(String id) => '/orders/$id/status';
  static String resolveOrderException(String id) => '/orders/$id/resolve-exception';
  static String forceUnassignOrder(String orderId) =>
      '/dispatch/orders/$orderId/force-unassign';

  // Refunds (OWNER/MANAGER/ADMIN)
  static const String adminRefundsPending = '/admin/refunds/pending';
  static String adminRefundUpdate(String id) => '/admin/refunds/$id';
