...
Widget _ordersIcon(Color color) => Icon(AppIcons.orders, size: 22, color: color);

Widget _ordersActiveIcon(Color color) => Icon(AppIcons.ordersFilled, size: 22, color: color);
